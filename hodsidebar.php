                ...
                <ul class="list">
                    <li>
                      ...
                      <?php }?>
                            <div class="detail">
                                <h4><?php echo $name;?></h4>
                                <small>Head Faculty</small>
                            </div>
                        </div>
                    </li>
                    <li class="header">HOD Menu</li>
                    <li><a href="headfaculty_dash.php"><i class="fa fa-institution"></i><span>Dashboard</span></a></li>
                   ...
                   <!-- <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-mortar-board" ></i><span>Head Faculty</span> </a>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-group"></i><span>Group</span> </a>
                        <ul class="ml-menu">
                            <li><a href="grp_allocate.php">Allocate Group</a></li>
                            <li><a href="allocated_group.php">View Allocate Group</a></li>
                            <!-- <li><a href="profile.html">Profile</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-calendar"></i><span>Schedule</span> </a>
                        <ul class="ml-menu">
                            <!-- <li><a href="">Generate Main Schedule</a></li> -->
                    ...
                    <li><a href="bar4.php?name=<?php echo 'headfaculty_dash.php';?>"> <i class="fa fa-file-text"></i><span>Generate Report</span></a></li>

                    <!-- <li><a href="javascript:void(0);" class="menu-toggle"><i class="fa fa-file-text"></i><span>Generate Report</span> </a>
                        <ul class="ml-menu">
                            <li><a href="bar4.php?name=<?php echo 'headfaculty_dash.php';?>">Preview Report</a></li>
