...
<section class="content profile-page">
    ...
    <?php 
                           ...
                           $res=mysqli_query($con,"select * from faculty_tbl where fid=$fid");
                ...
                <div class="card profile-header">
                    ...
                    <div class="profile-image"> <img src="upload/<?php echo $row['f_img'];?>" alt="Head Faculty"> </div>
                        <div>
                            ...
                            <?php if(mysqli_num_rows(mysqli_query($con,"select hid from headfaculty_tbl where fid=$fid and h_status=1"))>0){?><h5><span class="job_post">Head Faculty</span></h5><?php }?>
                            <h5><p><?php echo $row['f_email']?></p></h5>
                            <a href="add-faculty.php?upd=<?php echo $row[0]; ?>"><i
