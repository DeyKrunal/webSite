    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand " href="index.php"><img src="assets/images/pro_logo.jpg" class="hide-bg" width="40" alt="Progress Pilot"><span class="m-l-10">Progress Pilot</span></a>
            </div>
        </li>
